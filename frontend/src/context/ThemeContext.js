  ...
  const themeConfig = isDarkMode ? {
    ...
    components: {
      Layout: {
        ...
        colorBgBody: '#000000',
        colorBgTrigger: '#1a0000',
      },
      Menu: {
        colorBgContainer: '#0a0000',
        colorItemBg: '#0a0000',
        colorItemBgHover: '#1a0000',
        colorItemBgActive: '#330000',
        colorItemBgSelected: '#330000',
        colorItemText: '#ff6666',
        colorItemTextHover: '#ff0040',
        colorItemTextActive: '#ff0040',
        colorItemTextSelected: '#ff0040',
